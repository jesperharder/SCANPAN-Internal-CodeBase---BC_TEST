...
Report 50008 Salgsprisliste
{
	...
	WordLayout = './Layouts/Salgsprisliste.docx'; DefaultLayout = Word;
	...
	dataset
	{
		dataitem("Price List Line";"Price List Line")
		{
			...
			column(ReportForNav_PriceListLine; ReportForNavWriteDataItem('PriceListLine',"Price List Line")) {}
			...
			begin
				...
				"Price List Line".SetView(ReportForNav.OnPreDataItemView('PriceListLine',"Price List Line"));
			end;
	...
	begin
		...
		case (dataItemId) of
			'PriceListLine':
				begin
					currLanguage := GlobalLanguage; GlobalLanguage := 1033; jsonObject.Add('DataItem$PriceListLine$CurrentKey$Text',"Price List Line".CurrentKey); GlobalLanguage := currLanguage;
				end;
		end;
