...
Report 50003 Hyldelabel
{
	...
	Caption = 'Shelf Label';
	WordLayout = './Layouts/Hyldelabel.docx'; DefaultLayout = Word;
	...
	dataset
	{
		dataitem(Bin;Bin)
		{
			...
			column(ReportForNav_Bin; ReportForNavWriteDataItem('Bin',Bin)) {}
	...
	begin
		...
		case (dataItemId) of
			'Bin':
				begin
					currLanguage := GlobalLanguage; GlobalLanguage := 1033; jsonObject.Add('DataItem$Bin$CurrentKey$Text',Bin.CurrentKey); GlobalLanguage := currLanguage;
				end;
		end;
